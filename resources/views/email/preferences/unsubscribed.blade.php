...
<head>
    ...
    <title>Unsubscribed - NeoGiga</title>
    <style>
...
<body>
    <div class="container">
        ...
        <p>You will no longer receive marketing emails from NeoGiga. Transactional emails related to your account will still be sent.</p>
        <a href="{{ route('email.resubscribe', \App\Http\Controllers\Email\EmailPreferenceController::generateToken($subscriber)) }}" class="btn">Change Mind? Resubscribe</a>
    </div>
</body>
</html>
