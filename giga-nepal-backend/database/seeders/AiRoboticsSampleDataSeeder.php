    ...
    private function seedRobotModels(): void
    {
        ...
        $robots = [
            [
                ...
                'image' => 'https://developer.nvidia.com/sites/default/files/akamai/embedded/images/jetson/orin/nvidia-jetson-agx-orin-developer-kit.png',
                'seo_meta' => ['title' => 'NVIDIA Jetson AGX Orin Developer Kit — 275 TOPS Edge AI', 'description' => 'The most powerful edge AI development kit for robotics and autonomous machines. 275 TOPS AI performance.'],
            ],
            [
                ...
                'image' => 'https://developer.nvidia.com/sites/default/files/akamai/embedded/images/jetson/orin/nvidia-jetson-orin-nano-dev-kit.png',
                'seo_meta' => ['title' => 'NVIDIA Jetson Orin Nano — 40 TOPS Edge AI', 'description' => 'Entry-level edge AI development kit with 40 TOPS for robots and drones.'],
            ],
            [
                ...
                'image' => 'https://www.raspberrypi.com/app/uploads/2023/08/Raspberry-Pi-5-on-angle.jpg',
                'seo_meta' => ['title' => 'Raspberry Pi 5 AI Kit — Affordable AI Development', 'description' => 'Affordable AI development kit for education and prototyping with Raspberry Pi 5.'],
            ],
            [
                ...
                'image' => 'https://www.universal-robots.com/media/1812794/ur5e-hero-image.jpg',
                'seo_meta' => ['title' => 'Universal Robots UR5e — Collaborative Robot', 'description' => 'Flexible collaborative robot with 5kg payload and 850mm reach for manufacturing.'],
            ],
            [
                'name' => 'Spot Robot',
                ...
                'image' => 'https://bostondynamics.com/content/dam/bot/dot-com/images/products/spot/spot-gallery/spot-hero.jpg',
                'seo_meta' => ['title' => 'Boston Dynamics Spot — Agile Mobile Robot', 'description' => 'Agile quadruped robot for industrial inspection, construction monitoring, and research.'],
            ],
            [
                ...
                'image' => 'https://www.dji.com/content/images/dji-matrice-350-rtk/front.jpg',
                'seo_meta' => ['title' => 'DJI Matrice 350 RTK — Enterprise Drone', 'description' => 'Enterprise drone for mapping, inspection, and public safety. IP55 rated, 55-minute flight time.'],
            ],
            [
                ...
                'image' => 'https://www.intel.com/content/dam/www/central-libraries/us/en/images/intel-realSense-depth-camera-d455-front.png',
                'seo_meta' => ['title' => 'Intel RealSense D455 — Depth Camera for Robotics', 'description' => 'Stereo depth camera for robot navigation and perception. 6m range, 120° FOV.'],
            ],
            [
                ...
                'image' => 'https://developer.nvidia.com/sites/default/files/akamai/isaac-sim-overview.png',
                'seo_meta' => ['title' => 'NVIDIA Isaac Sim — Robot Simulation Platform', 'description' => 'Physically accurate robot simulation and digital twin platform powered by Omniverse.'],
            ],
        ];
    ...
    private function seedAiModels(): void
    {
        $models = [
            [
                ...
                'image' => 'https://raw.githubusercontent.com/ultralytics/assets/main/banner Ultralytics YOLOv8.png',
                'is_active' => true,
                'is_featured' => true,
            ],
            [
                ...
                'image' => 'https://raw.githubusercontent.com/facebookresearch/segment-anything/main/assets/sa_savanna.jpg',
                'is_active' => true,
                'is_featured' => true,
            ],
            [
                ...
                'image' => 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/OpenAI_Logo.svg/1200px-OpenAI_Logo.svg.png',
                'is_active' => true,
                'is_featured' => true,
            ],
            [
                ...
                'image' => 'https://raw.githubusercontent.com/Stability-AI/stablediffusion/main/assets/stable-sdxl.png',
                'is_active' => true,
                'is_featured' => false,
            ],
            [
                ...
                'image' => 'https://raw.githubusercontent.com/google-research/rrobotics-transformer2/main/media/rt2-teaser.png',
                'is_active' => true,
                'is_featured' => true,
            ],
            [
                ...
                'image' => 'https://raw.githubusercontent.com/meta-llama/codellama/main/logo.png',
                'is_active' => true,
                'is_featured' => true,
            ],
        ];
