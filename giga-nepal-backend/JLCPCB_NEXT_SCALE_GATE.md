...
- Started: review pending brands/categories created during failed stopped attempts. Admin now shows a read-only taxonomy review gate for top imported brand/category labels and flags generic mappings.
