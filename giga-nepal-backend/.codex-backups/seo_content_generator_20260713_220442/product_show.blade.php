...
{!! json_encode([
    ...
    'brand' => $product->brand?->name ? [
        ...
        'url' => url('/brand/'.$product->brand->slug),
    ] : null,
    'manufacturer' => $schemaManufacturer?->name ? [
        '@type' => 'Organization',
        'name' => $schemaManufacturer->name,
        'url' => url('/manufacturer/'.$schemaManufacturer->slug),
...
@php
    ...
    $brandUrl = $product->brand ? url('/brand/'.$product->brand->slug) : null;
    $manufacturerUrl = $manufacturerRecord ? url('/manufacturer/'.$manufacturerRecord->slug) : ($manufacturerName ? url('/manufacturer/'.\Illuminate\Support\Str::slug($manufacturerName)) : null);
    if ($product->brand) {
