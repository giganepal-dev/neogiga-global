...
<details class="modal">
    ...
    <div class="modal-panel">
        ...
        <form class="modal-b form-stack" method="post" action="/admin/products">@csrf
            <div class="tabs"><span class="tab active">1 Basic</span><span class="tab">2 MPN</span><span class="tab">3 Category</span><span class="tab">4 Specs</span><span class="tab">5 Pricing</span><span class="tab">6 Inventory</span><span class="tab">7 Media</span><span class="tab">8 SEO</span><span class="tab">9 Publish</span></div>
