...
<section class="page">
    <div class="wrap">
        ...
        <header class="page-head"><div><div class="eyebrow">Project requirements</div><h1 class="page-title">Create PCB project</h1><p class="lead">Define the commercial and engineering context before adding private design files.</p></div></header>
        ...
        <form class="card" method="post" action="/en/projects">
            ...
            <div class="card-body">
                <div class="form-grid">
                    ...
                    <div class="field full"><label for="description">Project brief</label><textarea class="control" id="description" name="description" placeholder="Board purpose, environment, interfaces, constraints and expected lifecycle.">{{ old('description') }}</textarea></div>
                    ...
                    <div class="field"><label for="target_budget">Target budget</label><input class="control" id="target_budget" type="number" step="0.01" min="0" name="target_budget" value="{{ old('target_budget') }}"></div>
                    ...
                    <div class="field"><label for="required_date">Required date</label><input class="control" id="required_date" type="date" name="required_date" min="{{ now()->addDay()->toDateString() }}" value="{{ old('required_date') }}"></div>
                    ...
                    <div class="field"><label for="shipping_postal_code">Postal code</label><input class="control" id="shipping_postal_code" name="shipping_postal_code" value="{{ old('shipping_postal_code') }}"></div>
                </div>
                <div class="form-actions"><button class="btn btn-primary" type="submit">Create project</button><a class="btn btn-light" href="/en/projects">Cancel</a></div>
            </div>
        </form>
    </div>
</section>
