...
@section('content')
<h1 style="margin:0 0 24px">Business Dashboard</h1>
<div class="kpi-grid">
    ...
    <div class="kpi"><div class="t">Status</div><div class="v"><span class="badge {{ ($b2b->is_active ?? true) ? 'b-ok' : 'b-muted' }}">{{ ($b2b->is_active ?? true) ? 'Active' : 'Inactive' }}</span></div><div class="s">account</div></div>
</div>
<div class="card"><h2 style="margin:0 0 12px;font-size:1rem">Quick Actions</h2>
    <div style="display:flex;gap:10px;flex-wrap:wrap">
        <a href="/b2b/products" class="btn btn-ghost">Manage Products</a>
        <a href="/b2b/orders" class="btn btn-ghost">View Orders</a>
    </div>
</div>
@endsection
