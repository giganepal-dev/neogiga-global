@extends('b2b.layout')
@section('title','Business Sign In')
@section('content')
<div style="max-width:420px;margin:60px auto">
    <h1 style="margin:0 0 8px;font-size:1.5rem">Business Sign In</h1>
    <p style="color:var(--muted);margin:0 0 24px">Access your b2b portal.</p>
    <div class="card">
        <form method="post" action="/b2b/login">
            @csrf
            @if($errors->any())
