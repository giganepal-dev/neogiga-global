...
<head>
    ...
    <title>@yield('title', 'Distributor Portal') — NeoGiga</title>
    <style>
...
<div class="top-bar"><div class="wrap">
    <a href="/distributor" class="brand" style="text-decoration:none">NeoGiga Distributor</a>
    <form method="post" action="/distributor/logout" style="margin:0">@csrf<button class="btn btn-ghost" type="submit">Sign Out</button></form>
</div></div>
<div class="wrap">
<div class="main-grid">
    <nav class="sidebar">
