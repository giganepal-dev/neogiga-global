...
@section('title','Distributor Sign In')
@section('content')
<div style="max-width:420px;margin:60px auto">
    <h1 style="margin:0 0 8px;font-size:1.5rem">Distributor Sign In</h1>
    <p style="color:var(--muted);margin:0 0 24px">Access your distributor portal.</p>
    <div class="card">
        <form method="post" action="/distributor/login">
            @csrf
            @if($errors->any())
