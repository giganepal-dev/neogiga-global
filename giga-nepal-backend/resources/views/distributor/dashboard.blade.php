...
@section('content')
<h1 style="margin:0 0 24px">Distributor Dashboard</h1>
<div class="kpi-grid">
    ...
    <div class="kpi"><div class="t">Status</div><div class="v"><span class="badge {{ ($distributor->is_active ?? true) ? 'b-ok' : 'b-muted' }}">{{ ($distributor->is_active ?? true) ? 'Active' : 'Inactive' }}</span></div><div class="s">account</div></div>
</div>
