...
<head>
    ...
    <title>Seller sign in · NeoGiga</title>
    <x-icon-styles/>
    <style>
...
<body>
    <form class="box" method="post" action="/seller/login">
        @csrf
        <h1><x-icon name="sellers" :size="22" label="Seller portal" /> Seller sign in</h1>
        <p class="sub">Manage your products, orders and payouts on NeoGiga.</p>
        ...
        <p class="alt">Not a seller yet? <a href="/sell-on-neogiga">Apply to sell on NeoGiga</a></p>
    </form>
</body>
</html>
