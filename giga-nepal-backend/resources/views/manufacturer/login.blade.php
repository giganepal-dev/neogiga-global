...
@section('title','Manufacturer Sign In')
@section('content')
<div style="max-width:420px;margin:60px auto">
    <h1 style="margin:0 0 8px;font-size:1.5rem">Manufacturer Sign In</h1>
    <p style="color:var(--muted);margin:0 0 24px">Access your manufacturer portal.</p>
    <div class="card">
        <form method="post" action="/manufacturer/login">
            @csrf
            @if($errors->any())
