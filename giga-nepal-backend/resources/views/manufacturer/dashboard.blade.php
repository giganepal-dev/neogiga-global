...
@section('content')
<h1 style="margin:0 0 24px">Manufacturer Dashboard</h1>
<div class="kpi-grid">
    ...
    <div class="kpi"><div class="t">Status</div><div class="v"><span class="badge {{ ($manufacturer->is_active ?? true) ? 'b-ok' : 'b-muted' }}">{{ ($manufacturer->is_active ?? true) ? 'Active' : 'Inactive' }}</span></div><div class="s">account</div></div>
</div>
<div class="card"><h2 style="margin:0 0 12px;font-size:1rem">Quick Actions</h2>
    <div style="display:flex;gap:10px;flex-wrap:wrap">
        ...
        <a href="/manufacturer/orders" class="btn btn-ghost">View Orders</a>
    </div>
</div>
@endsection
