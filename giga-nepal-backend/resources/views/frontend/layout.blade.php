...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}
        body{margin:0;background-color:var(--bg);color:var(--on);font-family:ui-sans-serif,system-ui,-apple-system,"Segoe UI",Roboto,Arial,sans-serif;line-height:1.55;letter-spacing:0;-webkit-font-smoothing:antialiased}
        ...
        .cat-icon{width:44px;height:44px;border-radius:12px;background:rgba(40,216,251,.12);color:var(--cyan);display:grid;place-items:center;font-weight:700;margin-bottom:12px}.product-card{display:flex;flex-direction:column;gap:10px}.product-img{position:relative;aspect-ratio:4/3;border-radius:10px;background-color:var(--s1);background-image:url('{{ url('/images/products/neogiga-product-placeholder-2026.png') }}');background-position:center;background-repeat:no-repeat;background-size:cover;display:grid;place-items:center;color:#fff;font-weight:700;text-shadow:0 1px 5px rgba(0,0,0,.9);overflow:hidden}.product-image-badges{position:absolute;z-index:2;top:8px;left:8px;display:flex;flex-wrap:wrap;gap:5px;max-width:calc(100% - 16px);pointer-events:none}.product-image-badge{display:inline-flex;align-items:center;min-height:22px;padding:2px 7px;border-radius:6px;font-size:.66rem;font-weight:800;letter-spacing:.02em;line-height:1;background:rgba(8,21,39,.92);border:1px solid rgba(255,255,255,.16);color:#fff;text-shadow:none;box-shadow:0 2px 9px rgba(0,0,0,.22)}.product-image-badge--genuine{background:rgba(5,105,70,.94);border-color:rgba(52,211,153,.65)}.product-image-badge--verified{background:rgba(7,89,133,.94);border-color:rgba(40,216,251,.65)}.product-image-badge--low{background:rgba(146,64,14,.95);border-color:rgba(249,189,44,.7)}.product-image-badge--hot{background:rgba(185,28,28,.95);border-color:rgba(252,165,165,.72)}.product-image-badge--featured{background:rgba(112,26,117,.95);border-color:rgba(232,121,249,.65)}
