...
<head>
    ...
    <style nonce="{{ $csp_nonce ?? '' }}">
        ...
        *{box-sizing:border-box}html{scroll-behavior:smooth}
        ...
        .cert-marks{display:flex;align-items:center;gap:6px;flex-wrap:wrap}.cert-mark{display:inline-flex;align-items:center;gap:5px;width:max-content;max-width:100%;padding:5px 8px;border:1px solid var(--line);border-radius:999px;font-size:.68rem;font-weight:800;line-height:1;color:var(--muted);background:var(--s2);text-decoration:none}.cert-mark.is-verified{color:#087657;border-color:#87d7ba;background:#effbf6}.cert-mark.is-pending{color:var(--muted);background:var(--s2)}.cert-marks-detail .cert-mark{font-size:.78rem;padding:8px 10px}.footer-trust{margin-top:26px;padding:20px 0;border-top:1px solid rgba(255,255,255,.12);display:grid;grid-template-columns:minmax(210px,.8fr) minmax(0,2.2fr);gap:20px;align-items:center}.footer-trust h3{margin:0 0 5px;color:#fff}.footer-trust p{margin:0}.standards-logos{display:flex;gap:10px;align-items:center;flex-wrap:wrap}.standard-logo{min-width:64px;height:44px;padding:0 12px;border:1px solid rgba(255,255,255,.22);border-radius:9px;display:grid;place-items:center;background:rgba(255,255,255,.06);color:#fff!important;font-size:.75rem;font-weight:900;letter-spacing:.04em;text-decoration:none}.standard-logo small{font-size:.52rem;font-weight:700;letter-spacing:0;color:#a9bad0}.standard-logo:hover{border-color:#f59e0b;background:rgba(245,158,11,.1)}
        ...
        @media(max-width:1024px){.hero-grid{grid-template-columns:1fr 1fr;gap:24px}.hero h1{font-size:clamp(2rem,5vw,3.2rem)}.foot-grid{grid-template-columns:repeat(3,1fr)}}
        ...
        @media(max-width:620px){.footer-trust{grid-template-columns:1fr}.standard-logo{min-width:58px}}
    ...
    <div class="wrap head-main">
        ...
        <div class="search-wrap">
            <form class="search" method="get" action="{{ $publicBase }}/products" role="search" autocomplete="off">
                <select name="category" aria-label="Category"><option value="">All categories</option>@foreach($searchCategories ?? [] as $cat)<option value="{{ $cat['slug'] }}">{{ $cat['name'] }}</option>@endforeach</select>
        ...
        <div class="wrap">
            <details class="mega">
                ...
                <div class="mega-panel">
                    ...
                    <div class="mega-col"><h3><x-icon name="pcb" size="14"/> Build</h3><a href="{{ $publicBase }}/ai">AI & Robotics</a><a href="{{ $publicBase }}/ai-commerce">AI Project Builder</a><a href="https://pcb.neogiga.com/en">PCB Fabrication</a><a href="{{ $publicBase }}/bom">BOM Tool</a><a href="/tools/smd-marking-code-identifier">SMD Code Identifier</a><a href="{{ $publicBase }}/lms">Learning Hub</a><a href="{{ $publicBase }}/rfq">Bulk RFQ</a><a href="{{ $publicBase }}/sell-on-neogiga">Become a Seller</a></div>
            ...
            <nav class="primary-nav" aria-label="Primary navigation">
                <a href="{{ $publicBase }}/products"><x-icon name="products" size="16"/> Products</a><a href="{{ $publicBase }}/categories"><x-icon name="categories" size="16"/> Categories</a><a href="{{ $publicBase }}/brands"><x-icon name="brands" size="16"/> Brands</a><a href="https://pcb.neogiga.com/en"><x-icon name="pcb" size="16"/> PCB</a><a href="{{ $publicBase }}/bom"><x-icon name="rfq" size="16"/> BOM Tool</a><a href="{{ $publicBase }}/ai"><x-icon name="ai-search" size="16"/> AI & Robotics</a><a href="{{ $publicBase }}/rfq"><x-icon name="rfq" size="16"/> RFQ</a><a href="{{ $publicBase }}/lms"><x-icon name="lms" size="16"/> LMS</a><a href="{{ $publicBase }}/distributors"><x-icon name="warehouses" size="16"/> Warehouses</a>
            </nav>
        </div>
    </div>
</header>
...
<footer class="footer">
    <div class="wrap">
        <div class="foot-grid">
            ...
            <div><h3>Tools</h3><a href="{{ $publicBase }}/ai">AI & Robotics</a><a href="{{ $publicBase }}/bom">BOM Tool / RFQ</a><a href="/tools/smd-marking-code-identifier">SMD Code Identifier</a><a href="https://pcb.neogiga.com/en">PCB Fabrication</a><a href="{{ $publicBase }}/ai-commerce">AI Project Builder</a><a href="{{ $publicBase }}/lms">Learning Hub</a><a href="{{ $publicBase }}/distributors">Warehouse Network</a></div>
        ...
        <section class="footer-trust" aria-labelledby="footer-standards-title">
            <div><h3 id="footer-standards-title">International standards &amp; certification references</h3><p>Product marks are displayed only from verified records. External standards links do not claim NeoGiga membership or corporate certification.</p></div>
            <div class="standards-logos" aria-label="International engineering and compliance references">
                <a class="standard-logo" href="https://www.ipc.org" target="_blank" rel="noopener noreferrer"><span>IPC<br><small>Standards</small></span></a>
                <a class="standard-logo" href="https://www.ieee.org" target="_blank" rel="noopener noreferrer"><span>IEEE<br><small>Resource</small></span></a>
                <span class="standard-logo" title="CE documentation category; not a NeoGiga certification">CE</span>
                <span class="standard-logo" title="RoHS documentation category; not a NeoGiga certification">RoHS</span>
                <span class="standard-logo" title="FCC documentation category; not a NeoGiga certification">FCC</span>
                <span class="standard-logo" title="ISO documentation category; not a NeoGiga certification">ISO</span>
            </div>
        </section>
