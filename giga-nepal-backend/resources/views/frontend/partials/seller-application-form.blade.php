...
<form class="ng-json-form" data-endpoint="/partner-applications/seller">
    ...
    <div class="form-grid">
        ...
        <div><label>Seller base country</label><select name="country_id" data-partner-country required><option value="">Detecting your country…</option></select><small class="muted" data-country-note></small></div>
        <div class="full"><label>Target marketplace countries</label><select name="target_marketplace_ids[]" data-partner-marketplaces multiple required size="4"><option value="">Loading active marketplaces…</option></select><small class="muted" data-marketplace-note>Select exactly one for single-country scope, or one or more for global scope. Use Ctrl/Command to select multiple.</small></div>
