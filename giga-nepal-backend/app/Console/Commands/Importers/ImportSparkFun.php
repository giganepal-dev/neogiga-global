...
use App\Services\Importers\SparkFunImporter;
...
class ImportSparkFun extends Command
{
    ...
    protected SparkFunImporter $importer;

    public function __construct(SparkFunImporter $importer)
    {
        parent::__construct();
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            $this->info('✅ SparkFun import completed successfully!');
