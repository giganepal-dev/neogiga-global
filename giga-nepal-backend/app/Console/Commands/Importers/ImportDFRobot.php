...
use App\Services\Importers\DFRobotImporter;
...
class ImportDFRobot extends Command
{
    ...
    protected DFRobotImporter $importer;

    public function __construct(DFRobotImporter $importer)
    {
        parent::__construct();
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            $this->info('✅ DFRobot import completed successfully!');
