...
class ImportAdafruit extends Command
{
    /**
     * The name and signature of the console command.
     */
    protected $signature = 'neogiga:import:adafruit 
     ...
     */
    protected $description = 'Import products from Adafruit (Tier 1 supplier)';

    protected AdafruitImporter $importer;

    public function __construct(AdafruitImporter $importer)
    {
        parent::__construct();
    ...
    {
        $this->info('🚀 Starting Adafruit import...');
        ...
        try {
            ...
            $this->info('✅ Adafruit import completed successfully!');
    ...
    /**
     * Import categories from Adafruit
     */
