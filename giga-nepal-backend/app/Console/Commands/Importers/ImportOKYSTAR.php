...
use App\Services\Importers\OKYSTARImporter;
...
class ImportOKYSTAR extends Command
{
    ...
    protected OKYSTARImporter $importer;

    public function __construct(OKYSTARImporter $importer)
    {
        parent::__construct();
    ...
    public function handle(): int
    {
        ...
        try {
            ...
            $this->info('✅ OKYSTAR import completed successfully!');
