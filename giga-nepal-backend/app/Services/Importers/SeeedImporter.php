...
class SeeedImporter extends BaseImporter
{
    ...
    protected string $baseUrl = 'https://www.seeedstudio.com';
    protected string $apiUrl = 'https://api.seeedstudio.com';
    ...
    public function normalizeProduct(array $product): array
    {
        return [
            ...
            'sku' => $product['sku'] ?? 'SS-' . $product['id'],
            'mpn' => $product['mpn'] ?? null,
            'brand_name' => 'Seeed Studio',
    ...
    {
        return ['api_key' => config('services.seeed.api_key'), 'rate_limit' => 10, 'batch_size' => 100];
    }
}
