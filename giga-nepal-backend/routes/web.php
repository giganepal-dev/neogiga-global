...
use App\Http\Controllers\Admin\BrandLogoAdminController;
...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('admin.web')->group(function () {
        ...
        Route::get('brand-logos', [BrandLogoAdminController::class, 'index'])->name('brand-logos.index');
        Route::post('brand-logos/bulk', [BrandLogoAdminController::class, 'bulk'])->name('brand-logos.bulk')->middleware(['admin.web.permission:catalog.manage', 'throttle:10,1']);
        Route::get('brand-logos/export-missing', [BrandLogoAdminController::class, 'exportMissing'])->name('brand-logos.export-missing')->middleware(['admin.web.permission:catalog.manage', 'throttle:10,1']);
        Route::post('brand-logos/{brand}/discover', [BrandLogoAdminController::class, 'discover'])->whereNumber('brand')->name('brand-logos.discover')->middleware(['admin.web.permission:catalog.manage', 'throttle:10,1']);
        Route::post('brand-logos/{brand}/upload', [BrandLogoAdminController::class, 'upload'])->whereNumber('brand')->name('brand-logos.upload')->middleware(['admin.web.permission:catalog.manage', 'throttle:10,1']);
        Route::post('brand-logos/{brand}/history/{history}/approve', [BrandLogoAdminController::class, 'approve'])->whereNumber(['brand', 'history'])->name('brand-logos.approve')->middleware(['admin.web.permission:catalog.manage', 'throttle:10,1']);
        Route::post('brand-logos/{brand}/history/{history}/reject', [BrandLogoAdminController::class, 'reject'])->whereNumber(['brand', 'history'])->name('brand-logos.reject')->middleware(['admin.web.permission:catalog.manage', 'throttle:10,1']);
        Route::post('brand-logos/{brand}/unavailable', [BrandLogoAdminController::class, 'unavailable'])->whereNumber('brand')->name('brand-logos.unavailable')->middleware(['admin.web.permission:catalog.manage', 'throttle:10,1']);
        Route::delete('brand-logos/{brand}', [BrandLogoAdminController::class, 'remove'])->whereNumber('brand')->name('brand-logos.remove')->middleware(['admin.web.permission:catalog.manage', 'throttle:10,1']);
